...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception{
		http.authorizeRequests()
			...
			.antMatchers(HttpMethod.OPTIONS,"/user/have-domain").permitAll()
			.antMatchers(HttpMethod.POST,"/user/have-domain").permitAll()
...
//			.antMatchers(HttpMethod.POST,"/sector/save").permitAll()			
			...
			.antMatchers(HttpMethod.OPTIONS,"/link/allByUserId/*").permitAll()
			.antMatchers(HttpMethod.GET,"/link/allByUserId/*").permitAll()
			.antMatchers(HttpMethod.OPTIONS,"/link/allByDomain/*").permitAll()
			.antMatchers(HttpMethod.GET,"/link/allByDomain/*").permitAll()
			.antMatchers(HttpMethod.OPTIONS,"/link/*").permitAll()
